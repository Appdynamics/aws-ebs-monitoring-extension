...
public class EBSMetricsProcessor implements MetricsProcessor {
    ...
    public EBSMetricsProcessor(List<IncludeMetric> includeMetrics, List<Dimension> dimensions) {
    ...
    public List<Metric> createMetricStatsMapForUpload(NamespaceMetricStatistics namespaceMetricStats) {
        ...
        for (Dimension dimension : dimensions) {
            dimensionToMetricPathNameDictionary.put(dimension.getName(), "Volume Id");
        }
